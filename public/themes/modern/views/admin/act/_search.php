...
<?php echo $form->textFieldRow($model, 'number', array('size' => 20, 'maxlength' => 255)); ?>

<?php echo $form->textFieldRow($model, 'sum', array('size' => 20, 'maxlength' => 255)); ?>
...
<?php echo $form->dropDownListRow($model, 'signed',
    array('1' => 'Да', '0' => 'Нет'),
    array('empty' => Yii::app()->params->emptySelectLabel)
); ?>
