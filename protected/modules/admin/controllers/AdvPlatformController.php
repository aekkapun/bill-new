...
class AdvPlatformController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['AdvPlatform'];
			if($model->save())
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='adv-platform-form')
		{
