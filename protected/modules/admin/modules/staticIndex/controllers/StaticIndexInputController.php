...
class StaticIndexInputController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('StaticIndexInput');
	...
	{
		$model=new StaticIndexInput('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['StaticIndexInput']))
			$model->attributes=$_GET['StaticIndexInput'];
