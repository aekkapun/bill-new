<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('is_corporate')); ?>:</b>
	<?php echo CHtml::encode($data->is_corporate); ?>
	<br />
	...
	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('code_1c')); ?>:</b>
	<?php echo CHtml::encode($data->code_1c); ?>
	<br />
